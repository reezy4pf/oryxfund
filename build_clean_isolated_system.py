...
[data-theme="dark"], html.dark, body.dark, [data-theme-mode="dark"] {
  ...
  --accent-amber: #F59E0B;
  --accent-red: #EF4444;
  --hero-bg: linear-gradient(145deg, #132218 0%, #0E1812 100%);
  --hero-text: #FAF8F5;
  --card-shadow: 0 12px 32px -5px rgba(0, 0, 0, 0.6);
...
""" + build_header("portal") + """
  ...
  <main class="oryx-portal-wrapper">
    ...
    <div class="oryx-hero-card oryx-noise-bg">
