    ...
    <div style="display:grid; grid-template-columns:2fr 1.2fr; gap:20px;">
      ...
      <div class="oryx-portal-card">
        ...
        <div style="border-top:1px solid var(--border-light); padding-top:20px; margin-top:20px;">
          <button type="button" class="oryx-btn oryx-btn-secondary" style="width:100%; margin-bottom:12px;" onclick="window.location.href='admin.html'">
            Switch to Admin Desk &rarr;
          </button>
          
          <button type="button" class="oryx-btn" style="width:100%; background:transparent; border:1px solid #DC2626; color:#DC2626;" onclick="logout()">
            Sign Out
          </button>
        </div>
      </div>
