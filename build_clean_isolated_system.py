...
@media (max-width: 768px) {
  ...
  .oryx-nav-mobile-right .oryx-capsule-tab {
    max-width: 135px;
    padding: 5px 10px;
    font-size: 11.5px;
    overflow: hidden;
  ...
  .oryx-mobile-capsules-track::-webkit-scrollbar {
    display: none;
  }
...
/* Primary Hero CTA (Apply for Loan - Vibrant Signature Emerald) */
.oryx-hero-btn-primary {
  background: #00D26A !important;
  color: #000000 !important;
  font-weight: 750 !important;
  border: 1px solid rgba(0, 210, 106, 0.5) !important;
  box-shadow: 0 4px 14px rgba(0, 210, 106, 0.28);
}

.oryx-hero-btn-primary:hover {
  background: #05E575 !important;
  color: #000000 !important;
  transform: translateY(-1.5px);
  box-shadow: 0 6px 20px rgba(0, 210, 106, 0.42);
}

.oryx-hero-btn-primary:active {
  transform: translateY(0);
  box-shadow: 0 2px 6px rgba(0, 210, 106, 0.2);
}

/* Secondary Hero CTA (Pay Loan - Crisp Sleek White) */
.oryx-hero-btn-secondary {
...
.oryx-hero-btn-secondary:active {
  transform: translateY(0);
  box-shadow: 0 2px 6px rgba(0, 0, 0, 0.1);
}

/* Dark Mode Overrides */
[data-theme="dark"] .oryx-hero-btn-primary,
html.dark .oryx-hero-btn-primary {
  background: #00D26A !important;
  color: #000000 !important;
  border-color: rgba(0, 210, 106, 0.6) !important;
  box-shadow: 0 4px 16px rgba(0, 210, 106, 0.35);
}

[data-theme="dark"] .oryx-hero-btn-primary:hover,
html.dark .oryx-hero-btn-primary:hover {
  background: #05E575 !important;
  color: #000000 !important;
  box-shadow: 0 6px 22px rgba(0, 210, 106, 0.5);
}

[data-theme="dark"] .oryx-hero-btn-secondary,
html.dark .oryx-hero-btn-secondary {
  background: #FFFFFF !important;
...
[data-theme="dark"] .oryx-hero-btn-secondary:hover,
html.dark .oryx-hero-btn-secondary:hover {
...
@media (max-width: 768px) {
  ...
  .card-section-head > .oryx-badge,
  .card-section-head > .status-tag {
  ...
  .card-section-head .section-desc {
    font-size: 12px;
  }
  .card-section-actions {
    display: grid;
...
/* ACCOUNT PAGE 2-COL GRID & ACTIONS */
.oryx-account-grid {
  display: grid;
  ...
  <header class="oryx-navbar">
    <div class="oryx-nav-inner">
      ...
      <div class="oryx-nav-mobile-right">
        ...
        <button type="button" class="oryx-theme-toggle-btn" onclick="toggleOryxTheme()" aria-label="Toggle Theme" title="Toggle Light / Dark Mode">
          <svg class="theme-icon sun-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>
          <svg class="theme-icon moon-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>
        </button>
      </div>
    ...
    <div class="oryx-portal-card" id="activeLoanSection">
      <div class="card-section-head">
        ...
        <div class="card-section-actions">
          <button type="button" class="oryx-btn oryx-btn-secondary" onclick="printStatement()">
            📄 Download Statement
          </button>
          <button type="button" class="oryx-btn oryx-btn-mpesa" onclick="openMpesaModal()">
            ⚡ Pay via M-Pesa
          </button>
        </div>
      </div>
    ...
    function renderDashboardState() {
      ...
      if (currentActiveLoan && currentActiveLoan.balance > 0) {
        ...
        loanCardEl.innerHTML = `
          <div style="background:var(--bg-surface); border:1px solid var(--border-color); border-radius:12px; padding:16px; margin-bottom:16px;">
    ...
    <div class="oryx-portal-card" id="formCardWrapper">
      <form id="oryxLoanForm" onsubmit="return false;">
        ...
        <div id="step-1-content" class="wizard-step-pane">
          ...
          <div class="wizard-nav-actions" style="justify-content:flex-end;">
  ...
  <main class="oryx-portal-wrapper">
    ...
    <div class="oryx-hero-card">
      ...
      <div class="hero-main-row">
        ...
        <div class="hero-cta-box">
          <a href="apply.html" class="oryx-hero-btn oryx-hero-btn-primary">+ Apply for a New Loan</a>
        </div>
      </div>
    </div>

    <!-- 2-Column Account Grid -->
    <div class="oryx-account-grid">
